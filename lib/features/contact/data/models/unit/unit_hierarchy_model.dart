...
class UnitProduct {
  ...
  factory UnitProduct.fromJson(Map<String, dynamic> j) => UnitProduct(
    ...
    luasBangunan: j['luas_bangunan'] is num
        ? (j['luas_bangunan'] as num).toDouble()
        : null,
