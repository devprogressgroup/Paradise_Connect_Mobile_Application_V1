...
class ContactModel extends ContactEntity {
  ...
  factory ContactModel.fromJson(Map<String, dynamic> json) {
    return ContactModel(
      ...
      salesGeneralManagerId: json['sales_general_manager_id'],
      ...
      salesGeneralManagerName: json['sales_general_manager_name'],
