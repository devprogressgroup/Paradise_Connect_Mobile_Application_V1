...
class GetSalesGeneralManagersUseCase {
  final ContactRepository repository;
  GetSalesGeneralManagersUseCase(this.repository);

  Future<Either<String, ({List<DropdownOption> data, int lastPage, int total})>> call({int page = 1, int perPage = 20, String? search}) {
    return repository.getSalesGeneralManagers(page: page, perPage: perPage, search: search);
  }
}
