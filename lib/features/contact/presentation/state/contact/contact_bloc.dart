...
class ContactBloc extends Bloc<ContactEvent, ContactState> {
  ...
  Future<void> _onFetchContacts(
    ...
    if (event.isRefresh) {
      emit(
        state.copyWith(
          ...
          salesChannelDetailIds: event.salesChannelDetailIds,
          salesTeamIds: event.salesTeamIds,
          salesExecutiveIds: event.salesExecutiveIds,
          salesSupervisorIds: event.salesSupervisorIds,
          salesManagerIds: event.salesManagerIds,
          salesGeneralManagerIds: event.salesGeneralManagerIds,
          ...
          clearSalesChannelDetail: event.clearSalesChannelDetail,
          clearSalesTeam: event.clearSalesTeam,
          clearSalesExecutive: event.clearSalesExecutive,
          clearSalesSupervisor: event.clearSalesSupervisor,
          clearSalesManager: event.clearSalesManager,
          clearSalesGeneralManager: event.clearSalesGeneralManager,
          ...
          lostStartDate: event.lostStartDate,
          lostEndDate: event.lostEndDate,
          lastProject: event.lastProject,
          ...
          clearLostDates: event.clearLostDates,
          clearProject: event.clearProject,
          sort: event.sort,
    ...
    final result = await getContactsUseCase(
      ...
      salesChannelDetailIds: event.clearSalesChannelDetail ? null : (event.salesChannelDetailIds ?? state.salesChannelDetailIds),
      salesTeamIds: event.clearSalesTeam ? null : (event.salesTeamIds ?? state.salesTeamIds),
      salesExecutiveIds: event.clearSalesExecutive ? null : (event.salesExecutiveIds ?? state.salesExecutiveIds),
      salesSupervisorIds: event.clearSalesSupervisor ? null : (event.salesSupervisorIds ?? state.salesSupervisorIds),
      salesManagerIds: event.clearSalesManager ? null : (event.salesManagerIds ?? state.salesManagerIds),
      salesGeneralManagerIds: event.clearSalesGeneralManager ? null : (event.salesGeneralManagerIds ?? state.salesGeneralManagerIds),
      ...
      lostStartDate: event.clearLostDates ? null : (event.lostStartDate ?? state.lostStartDate),
      lostEndDate: event.clearLostDates ? null : (event.lostEndDate ?? state.lostEndDate),
      lastProject: event.clearProject ? null : (event.lastProject ?? state.lastProject),
