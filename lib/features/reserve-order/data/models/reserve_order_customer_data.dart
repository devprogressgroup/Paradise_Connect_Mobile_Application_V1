...
class ReserveCustomerFieldSection {
  ...
  const ReserveCustomerFieldSection({
    required this.title,
    required this.fields,
  });
}

String? displayValueFor(
  ReserveCustomerFieldSpec field,
...
const List<String> roMaritalStatusItems = [
  'Belum Kawin',
  'Kawin',
  'Cerai Hidup',
  'Cerai Mati',
];
const List<String> roReligionItems = [
  'ISLAM',
  'KRISTEN',
  'KATOLIK',
  'HINDU',
...
const List<String> reserveWorkCategoryItems = [
  'Wiraswasta',
  'Pegawai',
  'Profesional',
];
...
const List<ReserveCustomerFieldSection> reserveCustomerFieldSections = [
  ReserveCustomerFieldSection(
    ...
    fields: [
      ...
      ReserveCustomerFieldSpec(
        key: 'cust_birth_date',
        label: 'Tanggal Lahir',
        kind: ReserveCustomerFieldKind.date,
      ),
      ReserveCustomerFieldSpec(
        key: 'cust_gender_is_male',
        label: 'Jenis Kelamin',
        kind: ReserveCustomerFieldKind.boolChoice,
        trueLabel: 'Laki-laki',
      ...
      ReserveCustomerFieldSpec(
        ...
        options: roMaritalStatusItems,
      ),
      ReserveCustomerFieldSpec(
        key: 'work_category',
        label: 'Kategori Pekerjaan',
        kind: ReserveCustomerFieldKind.option,
        options: reserveWorkCategoryItems,
      ),
      ReserveCustomerFieldSpec(
        key: 'cust_occupation',
        label: 'Pekerjaan',
      ...
      ReserveCustomerFieldSpec(
        key: 'cust_telp_mobile1',
        label: 'No. HP 1',
        keyboardType: TextInputType.phone,
      ),
      ReserveCustomerFieldSpec(
        key: 'cust_telp_mobile2',
        label: 'No. HP 2',
        keyboardType: TextInputType.phone,
      ),
      ReserveCustomerFieldSpec(
        key: 'cust_telp_mobile3',
        label: 'No. HP 3',
        keyboardType: TextInputType.phone,
      ),
      ReserveCustomerFieldSpec(
  ...
  ReserveCustomerFieldSection(
    title: 'Kontak Darurat (Tidak Tinggal Bersama)',
    fields: [
  ...
  ReserveCustomerFieldSection(
    title: 'Data Alamat Pembeli',
    fields: [
      ReserveCustomerFieldSpec(
        key: 'cust_address1',
        label: 'Alamat (sesuai KTP)',
        hint: 'mis. Nama Jalan No. 1…',
        maxLines: 2,
      ),
      ReserveCustomerFieldSpec(
        key: 'cust_area',
      ...
      ReserveCustomerFieldSpec(
        key: 'current_address_similar_ktp',
      ...
      ReserveCustomerFieldSpec(
        key: 'mailing_city',
        label: 'Kota Surat-Menyurat',
      ),
      ReserveCustomerFieldSpec(
        key: 'mailing_postal_code',
        label: 'Kode Pos Surat-Menyurat',
        keyboardType: TextInputType.number,
      ),
    ],
  ),
  ReserveCustomerFieldSection(
    ...
    fields: [
      ...
      ReserveCustomerFieldSpec(
        key: 'mate_ktp_postal_code',
        label: 'Kode Pos KTP',
        keyboardType: TextInputType.number,
      ),
      ReserveCustomerFieldSpec(
        key: 'mate_current_address',
        label: 'Alamat Saat Ini',
        maxLines: 2,
      ),
      ReserveCustomerFieldSpec(
      ...
      ReserveCustomerFieldSpec(
        key: 'mate_current_postal_code',
        label: 'Kode Pos Saat Ini',
        keyboardType: TextInputType.number,
      ),
      ReserveCustomerFieldSpec(
        key: 'mate_mailing_address',
        label: 'Alamat Surat-Menyurat',
        maxLines: 2,
      ),
      ReserveCustomerFieldSpec(
  ...
  ReserveCustomerFieldSection(
    ...
    fields: [
      ...
      ReserveCustomerFieldSpec(
        key: 'cust_office_building',
        label: 'Gedung Kantor',
      ),
      ReserveCustomerFieldSpec(
        key: 'cust_work_address',
        label: 'Alamat Kantor',
        maxLines: 2,
      ),
      ReserveCustomerFieldSpec(
  ...
  ReserveCustomerFieldSection(
    ...
    fields: [
      ...
      ReserveCustomerFieldSpec(
        key: 'spouse_company_name',
        label: 'Nama Perusahaan',
      ),
      ReserveCustomerFieldSpec(
        key: 'spouse_office_building',
        label: 'Gedung Kantor',
      ),
      ReserveCustomerFieldSpec(
        key: 'spouse_work_address',
        label: 'Alamat Kantor',
        maxLines: 2,
      ),
      ReserveCustomerFieldSpec(
