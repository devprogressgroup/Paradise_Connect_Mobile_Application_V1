  ...
  ReserveOrderDetail getOrder({bool rejected = false}) {
    return ReserveOrderDetail(
      ...
      rejectReason: rejected
          ? 'Foto KTP yang diupload buram dan NIK tidak terbaca jelas. Mohon upload ulang foto KTP yang lebih jernih.'
          : null,
      ...
      timeline: [
        const ReserveOrderTimelineStep(
          label: 'L1 Leads',
          sub: '18 Jul 2026',
          status: ReserveOrderStepStatus.done,
        ),
        const ReserveOrderTimelineStep(
          label: 'L2 APPT',
          sub: '20 Jul 2026',
        ...
        ReserveOrderTimelineStep(
          label: 'L4 Reserve',
          sub: rejected
              ? 'Diajukan 05 Sep 2026 · Rp 2.000.000 — ditolak, perlu revisi'
              : 'Diajukan 05 Sep 2026 · Rp 2.000.000 — sedang diverifikasi',
          subColor: rejected ? const Color(redColor) : null,
          status: rejected
              ? ReserveOrderStepStatus.todo
          ...
          notes: rejected
              ...
              : const [
                  ReserveOrderTimelineNote(
                    'Sistem',
                    'Top Up Booking Reserve Rp 3.000.000 diajukan (05 Sep, 11:30)',
                  ),
                ],
        ),
        const ReserveOrderTimelineStep(
          label: 'L5 Reserve Booking (R/BR)',
          status: ReserveOrderStepStatus.todo,
        ),
        const ReserveOrderTimelineStep(
          label: 'L6 SP',
          status: ReserveOrderStepStatus.todo,
        ...
        const ReserveOrderTimelineStep(
          label: 'L7 Collect Data',
          status: ReserveOrderStepStatus.todo,
        ),
        const ReserveOrderTimelineStep(
          label: 'L8 Proses Bank',
          status: ReserveOrderStepStatus.todo,
        ),
        const ReserveOrderTimelineStep(
          label: 'L9 SPK',
      ...
      notes: [
        ReserveOrderChatMessage(
          ...
          time: '05 Sep, 09:12',
          text:
              'Customer minta konfirmasi cicilan bisa mulai bulan depan, sudah saya sampaikan ke Kasir ya.',
        ...
        ReserveOrderChatMessage(
          ...
          time: '05 Sep, 10:40',
          text:
              'Noted, TTS akan saya buat setelah bukti transfer diverifikasi.',
