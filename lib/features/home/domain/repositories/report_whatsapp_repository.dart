...
import 'package:progress_group/features/home/data/models/sales_channel_summary_model.dart';
...
abstract class ReportRepository {
  ...
  Future<SalesChannelSummaryEntity> getSalesChannelsSummary({String? startDate, String? endDate});
}
...
class ReportRepositoryImpl implements ReportRepository {
  ...
  @override
  Future<SalesChannelSummaryEntity> getSalesChannelsSummary({String? startDate, String? endDate}) async {
    final result = await remoteDataSource.getSalesChannelsSummary(startDate: startDate, endDate: endDate);
    if (result['status'] == true) {
      return SalesChannelSummaryModel.fromJson(result['data']);
    } else {
      throw Exception(result['message'] ?? "Error");
    }
  }
