...
abstract class AttendanceRemoteDataSource {
  ...
  Future<Map<String, dynamic>> getAllOfficeLocations();
...
class AttendanceRemoteDataSourceImpl implements AttendanceRemoteDataSource {
  ...
  @override
  Future<Map<String, dynamic>> getAllOfficeLocations() async {
    final response = await dio.get('/attendance/locations/office/all');
    return response.data;
  }
